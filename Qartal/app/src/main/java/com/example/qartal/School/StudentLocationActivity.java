...
public class StudentLocationActivity extends AppCompatActivity implements
    ...
    private void setInitialLocation() {
        ...
        if (ActivityCompat.checkSelfPermission( StudentLocationActivity.this, Manifest.permission.ACCESS_FINE_LOCATION )
                != PackageManager.PERMISSION_GRANTED &&
                ActivityCompat.checkSelfPermission( StudentLocationActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION )
                        != PackageManager.PERMISSION_GRANTED) {
            return;
        }
    ...
    private void CheckMapPermission() {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (ActivityCompat.checkSelfPermission( StudentLocationActivity.this, Manifest.permission.ACCESS_FINE_LOCATION ) != PackageManager.PERMISSION_GRANTED &&
                    ActivityCompat.checkSelfPermission( StudentLocationActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION ) != PackageManager.PERMISSION_GRANTED) {
                ActivityCompat.requestPermissions( StudentLocationActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION}, 1002 );
            } else {
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.go_back_profile_to:{
                Intent i = new Intent(getApplicationContext(), SchoolMainProfileActivity.class);
                startActivity(i);
            }break;
        }
    }
